...
export default function MetodoJacobi() {
  ...
  const resolverJacobi = () => {
    try {
      ...
      while (error > tol && iteracion < maxIter) {
        ...
        const nuevoX = ecuacionX.evaluar({ x, y, z });
        const nuevoY = ecuacionY.evaluar({ x, y, z });
        const nuevoZ = ecuacionZ.evaluar({ x, y, z });
  ...
  return (
    <div className="mt-6 p-4 bg-white rounded-lg shadow">
      <h3 className="text-xl font-semibold text-[#424874] mb-4">Método de Jacobi</h3>
